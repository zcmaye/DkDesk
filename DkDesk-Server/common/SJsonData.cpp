...
bool SJsonData::boolValue(const std::string& key)const
{
	auto item = cJSON_GetObjectItem(_root, key.data());
	if (item)
	{
...
double SJsonData::numberValue(const std::string& key)const
{
	auto item = cJSON_GetObjectItem(_root, key.data());
	if (item)
	{
...
std::string SJsonData::stringValue(const std::string& key)const
{
	auto item = cJSON_GetObjectItem(_root, key.data());
	if (item)
	{
...
bool SJsonData::isNullValue(const std::string& key)const
{
	auto item = cJSON_GetObjectItem(_root, key.data());
	if (item)
	{
